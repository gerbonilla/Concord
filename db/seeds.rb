...
# Create Profile
gerardo_profile = Profile.create(user: gerardo, first_name: 'Gerardo', last_name: 'Bonilla', address: 'Stargarder Str. 72', transfer_pin: '3333', language: 'english')
diego_profile = Profile.create(user: diego, first_name: 'Diego', last_name: 'Bonilla', address: 'Stargarder Str. 72', transfer_pin: '3333', language: 'english')
